...
#import "MonthDayCollectionCell.h"

#import "UseTimeData.h"

@interface MonthDayViewController ()
...
- (void)viewDidLoad {
    ...
    //注册
    [self.collectionView registerClass:[MonthDayCollectionCell class] forCellWithReuseIdentifier:reuseIdentifier];
    //注册头部
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MonthDayCollectionCell *cell = (MonthDayCollectionCell *)[collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    ...
    if (indexPath.item <firstCorner || indexPath.item>lastConter) {
        ...
        if (cell.selectedBackgroundView == nil) {
            ...
            selectBgView.backgroundColor =  CJColor(28, 124, 255);           selectBgView.layer.cornerRadius = wh/2;
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    MonthDayCollectionCell *cell = (MonthDayCollectionCell *)[collectionView cellForItemAtIndexPath:indexPath];
