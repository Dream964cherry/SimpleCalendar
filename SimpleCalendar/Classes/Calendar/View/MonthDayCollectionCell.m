...
@interface MonthDayCollectionCell()
...
@implementation MonthDayCollectionCell
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        NSArray *arrayOfViews = [[NSBundle mainBundle] loadNibNamed:@"MonthDayCollectionCell" owner:self options:nil];
